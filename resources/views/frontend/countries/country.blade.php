                ...
                <div class="col-lg-12">
                    ...
                    <section id="description">
                        ...
                        <!-- Start of Logos Section -->
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-6">
                                    <img src="{{asset('images/img/upesi/barclays.jpg')}}">
                                </div>
                                <div class="col-lg-2 col-6">
                                    <img src="{{asset('images/img/upesi/equity.jpg')}}">
                                </div>
                                <div class="col-lg-2 col-6">
                                    <img src="{{asset('images/img/upesi/kcb.jpg')}}">
                                </div>
                                
                                <div class="col-lg-2 col-6">
                                    <img src="{{asset('images/img/upesi/stanchart.jpg')}}">
                                </div>
                                <div class="col-lg-2 col-6">
                                    <img src="{{asset('images/img/upesi/cfc.jpg')}}">
                                </div>
                                <div class="col-lg-2 col-6">
                                    <img src="{{asset('images/img/upesi/coop.jpg')}}">
                                </div>
                                <div class="col-lg-2 col-6">
                                    <img src="{{asset('images/img/upesi/dtb.jpg')}}">
                                </div>
                                <div class="col-lg-2 col-6">
                                    <img src="{{asset('images/img/upesi/im.jpg')}}">
                                </div>
                                <div class="col-lg-2 col-6">
                                    <img src="{{asset('images/img/upesi/national.jpg')}}">
                                </div>
                                <div class="col-lg-2 col-6">
                                    <img src="{{asset('images/img/upesi/spire.jpg')}}">
                                </div>
                            </div>
                        ...
                        <!-- Start of Logos Section -->
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-6">
                                    <img src="{{asset('images/img/upesi/upesi-logo.jpg')}}">
                                </div>
                                <div class="col-lg-2 col-6">
                                    <img src="{{asset('images/img/upesi/ngao-credit.jpg')}}">
                                </div>
                                <div class="col-lg-2 col-6">
                                    <img src="{{asset('images/img/upesi/equity.jpg')}}">
                                </div>
                        ...
                        <!-- Start of Logos Section -->
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-6">
                                    <img src="{{asset('images/img/upesi/mpesa.jpg')}}">
                                </div>
