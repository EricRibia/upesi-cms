		...
		<div id="full-slider-wrapper">
			<div id="layerslider" style="width:100%;height:550px;">
				...
				<div class="ls-slide" data-ls="slidedelay: 5000; transition2d:85;">
					<img src="{{ asset('images/img/upesi/upesi-slider-4.jpg') }}" class="ls-bg" alt="Slide background">
				...
				<!-- second slide -->
				<div class="ls-slide" data-ls="slidedelay: 5000; transition2d:85;">
					<img src="{{ asset('images/img/upesi/upesi-slider-3.jpg') }}" class="ls-bg" alt="Slide background">
				...
				<!-- third slide -->
				<div class="ls-slide" data-ls="slidedelay: 5000; transition2d:85;">
					<img src="{{ asset('images/img/upesi/upesi-slider-2.jpg') }}" class="ls-bg" alt="Slide background">
					
						<h4 class="ls-l slide_typo" style="top: 75%;left:50%;" data-ls="offsetxin:0;durationin:2000;delayin:1000;easingin:easeOutElastic;rotatexin:90;transformoriginin:50% bottom 0;offsetxout:0;rotatexout:90;transformoriginout:50% bottom 0;">
							Receive Money Instantly</h4>
						<p class="ls-l slide_typo" style="top:85%;left:50%;" data-ls="durationin:2000;delayin:1000;easingin:easeOutElastic;">
							With mobile wallet, you can receive money instantly on your phone
						</p>
		...
		<div class="container">
			...
			<div class="row">
				...
				<section class="customer-logos slider">
			      <div class="slide"><a href="https://www.worldremit.com/" target="_blank"><img src="{{ asset('images/img/upesi/world-remit.jpg') }}"></a></div>
			      <div class="slide"><a href="http://www.alansari.com/" target="_blank"><img src="{{ asset('images/img/upesi/cash-express.jpg') }}"></a></div>
			      <div class="slide"><a href="https://www.moneytrans.eu/" target="_blank"><img src="{{ asset('images/img/upesi/moneytrans-logo.jpg') }}"></a></div>
			      <div class="slide"><a href="https://www.smallworldfs.com/small-world/usa/en-us" target="_blank"><img src="{{ asset('images/img/upesi/small-world.jpg') }}"></a></div>
			      <div class="slide"><a href="https://www.transfast.com/" target="_blank"><img src="{{ asset('images/img/upesi/transfast.jpg') }}"></a></div>
			      <div class="slide"><a href="http://www.uremit.ca/" target="_blank"><img src="{{ asset('images/img/upesi/uremit.jpg') }}"></a></div>
